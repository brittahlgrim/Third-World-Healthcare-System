...
mysql --user=root --password="benbrittdavidjpsydney" -e "drop database twhs_test_db"
mysql --user=root --password="benbrittdavidjpsydney" -e "create database twhs_test_db"
mysql --user=root --password="benbrittdavidjpsydney" twhs_test_db < ./db/records_db_table_structure.sql
