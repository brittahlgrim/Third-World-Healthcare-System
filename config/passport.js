...
module.exports = function(passport, dbConnection) {
    ...
    function(req, username, password, done) {
        ...
        var queryString = "SELECT TOP 1 * FROM TEST.dbo.Users WHERE username = ?";
        ...
        dbConnection.query(queryString, username, function(err, rows, fields) {
            ...
            if (user) {
                ...
                var insertSqlQuery = "INSERT INTO TEST.dbo.Users (username, password) VALUES (?, ?)";
                dbConnection.query(insertSqlQuery, username, passwordHash, function(){
                });
